...
PATH=$PATH:~/MATLAB/R2022a/bin
PATH=$PATH:/usr/local/go/bin
PATH=$PATH:~/app-images

# pip installs shit here
PATH=$PATH:~/.local/bin

# it is import to prepend the texlive bin here, to override the system installed 
# latex commands, ie pdflatex
...
# calibre uninstaller at /usr/bin/calibre-uninstall/
